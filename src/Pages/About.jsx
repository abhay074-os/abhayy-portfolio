...
const AboutPage = () => {
  ...
  return (
    <section
      id="About"
      className="w-full min-h-screen px-[5%] lg:px-[10%] py-20 text-white bg-[#030014] overflow-hidden"
    >
      {/* Header */}
      <div className="text-center mb-16" data-aos="fade-up">
        ...
        <p className="mt-4 text-gray-400 flex justify-center items-center gap-2 text-sm md:text-base">
        ...
        <div data-aos="fade-right">
          ...
          <div className="bg-white/5 backdrop-blur-md border border-white/10 p-5 rounded-xl mb-6">
            <p className="italic text-gray-300 text-sm">
              "Using AI as a professional tool to enhance productivity,
          ...
          <div className="flex flex-wrap gap-4">
            ...
            <a
              href="/abhaycv.pdf"
              download="Abhay_Potdar_CV.pdf"
              className="px-6 py-3 rounded-lg bg-gradient-to-r from-[#6366f1] to-[#a855f7] hover:scale-105 transition-all duration-300 flex items-center gap-2 shadow-lg hover:shadow-xl"
            >
            ...
            <a
              href="#Portfolio"
              className="px-6 py-3 rounded-lg border border-purple-500 text-purple-400 hover:bg-purple-500/10 transition-all duration-300 flex items-center gap-2"
            >
        ...
        <div className="flex justify-center" data-aos="fade-left">
          <div className="relative w-72 h-72 md:w-96 md:h-96">
            ...
            <img
              src="/photo1.png"
              alt="Abhay Potdar"
              className="relative w-full h-full rounded-full object-cover border-4 border-white/10 shadow-2xl hover:scale-105 transition-all duration-500"
            />
          </div>
        </div>
