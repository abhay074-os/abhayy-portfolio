...
const WORDS = ["PHP & MySQL Developer", "AI Backend Enthusiast"];
const TECH_STACK = ["PHP", "MySQL", "React", "Supabase", "JavaScript"];
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/abhay074-os", label: "GitHub Profile" },
  { icon: Linkedin, link: "https://www.linkedin.com/in/abhayy-potdar/", label: "LinkedIn Profile" },
  { icon: Instagram, link: "https://www.instagram.com/abhayy_potdar", label: "Instagram Profile" }
];
...
const Home = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Abhay Potdar — Backend Developer</title>
        <meta name="description" content="Abhay Potdar - Backend-focused developer skilled in PHP, MySQL, and scalable web application architecture." />
      </Helmet>
              ...
              <div className="w-full lg:w-1/2 space-y-6 sm:space-y-8 text-left lg:text-left order-1 lg:order-1 lg:mt-0"
                ...
                <div className="space-y-4 sm:space-y-6">
                  ...
                  <p className="text-base md:text-lg text-gray-400 max-w-xl leading-relaxed font-light"
                    data-aos="fade-up"
                    data-aos-delay="1000">
                    Building secure, scalable, and database-driven web applications with clean architecture and performance-focused design.
                  </p>
